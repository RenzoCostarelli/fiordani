...
import { getPizarraRosarioData } from "@/lib/getPizarraData";
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch pizarra rosario data using shared function
    const data = await getPizarraRosarioData(fecha);
    ...
    console.error("Error in /api/pizarra-rosario:", error);
    return NextResponse.json(
